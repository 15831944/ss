...
QG_ActionHandler::QG_ActionHandler(QObject* parent)
    :QObject(parent),
      arrangeWidget(new ss_Arrange((QC_ApplicationWindow *)(this->parent()))),
      sortWidget(new ss_SortWidget((QC_ApplicationWindow *)(this->parent()))),
...
RS_ActionInterface* QG_ActionHandler::setCurrentAction(RS2::ActionType id) {
    ...
    case RS2::ActionSelectUnclosed:
        a = new sx_UnclosedSelect(*document, *view,getCurrentAction());
        break;
    case RS2::ActionSelectSmallSize:
        a = new sx_SmallSizeSelect(*document, *view,getCurrentAction());
        break;
    case RS2::ActionDefineGroup:
        a = new sx_DefineGroup(*document, *view);
        break;
    case RS2::ActionBreakSelectGroup:
        a = new sx_BreakSelectGroup(*document, *view);
        break;
    case RS2::ActionBreakAllGroup:
        a = new sx_BreakAllGroup(*document, *view);
        break;
    ...
    case RS2::ActionModifyScaleNoSelect:
        ...
        break;
        /*飞切*/
    case RS2::ActionFlyingCut:
        if(document->countSelected()<2){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionFlyingCutNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionFlyingCutNoSelect:
        a = new actionflyingcutnew(*document, *view,0);
        break;
        /*去除小图形*/
    case RS2::ActionRemoveSmall:
        a = new rs_actionremovesmall(*document, *view);
        break;
        /*圆弧飞切*/
    case RS2::ActionFlyingCutArc:
        if(document->countSelected()<2){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionFlyingCutNoSelect);
            break;
        }
    case RS2::ActionFlyingCutArcNoSelect:
        a = new actionflyingcutnew(*document, *view,1);
        break;

    case RS2::ActionCompensate:
        if(!document->countSelected()){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionCompensateNoSelect);
            break;
        }
    case RS2::ActionCompensateNoSelect:
        a = new rs_actioncompensatenew(*document, *view);
        break;


        /*合并相连线*/
    case RS2::ActionMerge:
        if(document->countSelected()<2){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionMergeNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionMergeNoSelect:
        a = new rs_actionmergenew(*document, *view);
        break;



        /*对齐*/
    case RS2::ActionAlignLeft:
        if(!document->countSelected()){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionAlignLeftNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionAlignLeftNoSelect:
        a = new RS_ActionAlign(*document, *view,1);
        break;

        /*微连*/
    case RS2::ActionWelian:
        a = new rs_actionweilian(*document, *view);
        break;

    case RS2::ActionSetWire:
        a = new rs_actionsetwire(*document, *view);
        break;



    case RS2::ActionAlignRight:
        if(!document->countSelected()){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionAlignLeftNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionAlignRightNoSelect:
        a = new RS_ActionAlign(*document, *view,2);
        break;

    case RS2::ActionAlignHorizontal:
        if(!document->countSelected()){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionAlignLeftNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionAlignHorizontalNoSelect:
        a = new RS_ActionAlign(*document, *view,3);
        break;

    case RS2::ActionAlignTop:
        if(!document->countSelected()){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionAlignLeftNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionAlignTopNoSelect:
        a = new RS_ActionAlign(*document, *view,4);
        break;

    case RS2::ActionAlignBottom:
        if(!document->countSelected()){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionAlignLeftNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionAlignBottomNoSelect:
        a = new RS_ActionAlign(*document, *view,5);
        break;

    case RS2::ActionVerticalCenter:
        if(!document->countSelected()){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionAlignLeftNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionVerticalCenterNoSelect:
        a = new RS_ActionAlign(*document, *view,6);
        break;

    case RS2::ActionCenterAlignment:
        if(!document->countSelected()){
            a = new RS_ActionSelect(this, *document, *view, RS2::ActionAlignLeftNoSelect);
            break;
        }
        // fall-through
    case RS2::ActionCenterAlignmentNoSelect:
        a = new RS_ActionAlign(*document, *view,7);
        break;
    ...
    case RS2::ActionBlocksExplodeNoSelect:
        ...
        break;
    case RS2::ActionRectArray:
        a = new sx_rectangleArray(*document, *view);
        break;
    case RS2::ActionInteractiveArray:
        a = new sx_arrayData(*document, *view);
        break;
    case RS2::ActionDeleteRepeat:
        a = new deleteRepeat(*document, *view);
        break;
        // library browser:
        //
...
void QG_ActionHandler::slotRemoveSmall()
{
    setCurrentAction(RS2::ActionRemoveSmall);
}
...
void QG_ActionHandler::slotSelectUnclosed() {
    setCurrentAction(RS2::ActionSelectUnclosed);
}

void QG_ActionHandler::slotSelectExternal() {
    setCurrentAction(RS2::ActionSelectExternal);
}

void QG_ActionHandler::slotSelectSmallSize() {
    setCurrentAction(RS2::ActionSelectSmallSize);
}

void QG_ActionHandler::slotDefineGroup() {
    setCurrentAction(RS2::ActionDefineGroup);
}

void QG_ActionHandler::slotBreakSelectGroup(){
    setCurrentAction(RS2::ActionBreakSelectGroup);
}

void QG_ActionHandler::slotBreakAllGroup(){
    setCurrentAction(RS2::ActionBreakAllGroup);
}
...
void QG_ActionHandler::slotWelian() //微连
{
    setCurrentAction(RS2::ActionWelian);
}

void QG_ActionHandler::slotSetWire()//引线
{
    setCurrentAction(RS2::ActionSetWire);
}

void QG_ActionHandler::slotMerge()
{
    setCurrentAction(RS2::ActionMerge);
}
...
void QG_ActionHandler::slotAlignLeft()
{
    setCurrentAction(RS2::ActionAlignLeft);
}

void QG_ActionHandler::slotAlignRight()
{
    setCurrentAction(RS2::ActionAlignRight);
}

void QG_ActionHandler::slotAlignHorizontal()
{
    setCurrentAction(RS2::ActionAlignHorizontal);
}

void QG_ActionHandler::slotAlignTop()
{
    setCurrentAction(RS2::ActionAlignTop);
}

void QG_ActionHandler::slotAlignBottom()
{
    setCurrentAction(RS2::ActionAlignBottom);
}

void QG_ActionHandler::slotVerticalCenter()
{
    setCurrentAction(RS2::ActionVerticalCenter);
}

void QG_ActionHandler::slotCenterAlignment()
{
    setCurrentAction(RS2::ActionCenterAlignment);
}
...
void QG_ActionHandler::slotRectArray() {      //阵列
    setCurrentAction(RS2::ActionRectArray);
}


void QG_ActionHandler::slotCompensate()//补偿
{
    setCurrentAction(RS2::ActionCompensate);
}

void QG_ActionHandler::slotFlyingCut() //飞切
{
    setCurrentAction(RS2::ActionFlyingCut);
}

void QG_ActionHandler::slotFlyingCut1()
{
    setCurrentAction(RS2::ActionFlyingCutArc);
}

void QG_ActionHandler::slotInteractive(){
    setCurrentAction(RS2::ActionInteractiveArray);
}

void QG_ActionHandler::slotDeleteRepeat(){
    setCurrentAction(RS2::ActionDeleteRepeat);
}
...
void QG_ActionHandler::slotFileOpenPreview(){

    m_fileOpen->file_dialog->show();
    m_fileOpen->show();
}

void QG_ActionHandler::slotExportGCode()
{
//    //auto m_AppWin=QC_ApplicationWindow::getAppWindow();
//    ncFileIo a;
//    a.m_file=*m_app->m_result_file_list[m_app->getDocument()];
//    std::string result=a.generate_g_code();
//    QString qstr= QString::fromStdString(result);

//    QString fileName = QFileDialog::getSaveFileName(NULL,tr("保存G代码"),"",tr("后处理文件(*.NC)"));
//    QFile file(fileName);

//    if (!file.open(QIODevice::WriteOnly|QIODevice::Text))
//    {
//        //QMessageBox::critical(this, "critical", tr("文件保存失败！"),QMessageBox::Yes|QMessageBox::No, QMessageBox::Yes);
//    }
//    else
//    {
...
void QG_ActionHandler::slotArrange(){

    arrangeWidget->setModal(false);
    arrangeWidget->show();
}


void QG_ActionHandler::slotAddFactory(){
    ...
    QList<RS_Entity*> seletEntities;
    foreach(auto item,EntityList)
    {
        if(item->isSelected())
        {
            seletEntities.push_back(item);
        }
    }

//    ss_PartFrame a=new ss_PartFrame();
//    a.addToFactory(a.spiltPart(seletEntities));
    ss_PartFrame::addToFactory(ss_PartFrame::spiltPart(seletEntities));
}
