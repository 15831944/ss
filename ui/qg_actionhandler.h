...
#include "sinsun/ss_openfilepre.h"
...
public slots:
    void slotFileOpenPreview();
    void slotExportGCode();
    void slotArrange();
    void slotAddFactory();
    void slotLengQue();
    void slotYinXian();
    ...
    void slotSelectUnclosed();
    void slotSelectExternal();
    void slotSelectSmallSize();
    void slotRemoveSmall();
    void slotMerge();
    void slotSetWire();

    void slotDefineGroup();
    void slotBreakSelectGroup();
    void slotBreakAllGroup();
    ...
    void slotVerticalCenter();
    void slotCenterAlignment();
