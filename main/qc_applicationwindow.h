...
public:
    TitleBar *pTitleBar;
    bool enable_left_sidebar;
    LC_WidgetFactory *widget_factory;
...
public slots:
    void slotPartFileOpen();
    void slotfilesSelected(QString);
...
private:
    ...
    ss_PartWidget* partWidget{nullptr};
